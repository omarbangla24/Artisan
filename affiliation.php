...
<section class="section">
  <div class="container">
    <div class="head">
      <div class="reveal">
        <span class="chip">Affiliation &amp; Membership of the Firm</span>
        <h2>Professional memberships <em>&amp; certifications.</em></h2>
      </div>
      <div class="head-note reveal" data-delay="80">
        <p class="mb-0">Our partners are involved (through membership and/or certification) with the following organizations:</p>
      </div>
    </div>

    <div class="contact-grid" style="margin-top:var(--gap)">
      <article class="pcard reveal">
        <span class="role">ICAB</span>
        <h3>Institute of Chartered Accountants of Bangladesh</h3>
      </article>
      <article class="pcard reveal" data-delay="60">
        <span class="role">ICSB</span>
        <h3>Institute of Company Secretaries of Bangladesh</h3>
      </article>
      <article class="pcard reveal" data-delay="120">
        <span class="role">IPA Australia</span>
        <h3>Institute of Public Accountants</h3>
      </article>
    </div>
  </div>
</section>
